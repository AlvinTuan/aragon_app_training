...
const DaosDetailsHeader = () => {
    ...
    return (
        <>
                ...
                <div className="header-container">
                    ...
                    <div className="header--left">
                        <div className="header__user">
                            <p className="user__avatar">{exploreDaosItem?.avatar}</p>
                            <p className="user__title">{exploreDaosItem?.title}</p>
            ...
            <div className="header-ltePC">
                <button className="menu" onClick={() => setShowModalHeader(true)}>
                    <div className="strike-span">
                        <span></span>
                        <span></span>
                    </div>
                    <p className="menu-text">Menu</p>
                </button>
                <ModalHeader open={showModalHeader} handleClose={() => setShowModalHeader(false)}></ModalHeader >
                <div className="user">
